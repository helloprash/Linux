...
int main() 
{
    ...
    char fileName[40];
	   ...
	   fptr = fopen(fileName,"w");
           fprintf(fptr,"<HTML>");
	   fprintf(fptr,"<H1><center>Prashanth Kumar B</center></H1>");
	   ...
	   char buff[] = "<body><img src=\"/home/prash/prashanth/prashanth.png\"><body>";
	   fprintf(fptr,"%s",buff);
           fprintf(fptr,"</HTML>");
	   fclose(fptr);
	   ...
	   if(strncmp(buffer,"GET /prashanth.png",16))
	   {
	      int fdimg = open("prashanth.png",O_RDONLY);
	      sendfile(new_socket, fdimg, NULL, 170000);
	      close(fdimg);
	   }
